...
public class Test {
    ...
    private String date;//用户测试的时间
    private String parents;
    private String grandparents;
    private String brothers;

    public Test(long id, String sex, int age, double times, double rate, String date, String parents, String grandparents, String brothers) {
        this.id = id;
        this.sex = sex;
        this.age = age;
        this.times = times;
